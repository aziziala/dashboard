...
export class ClientService {
  ...
  private get baseUrl(): string {
    return this.taxiService.getBaseUrl();
  }
  ...
  getClientByPhoneSingle(phone: string): Observable<Client> {
    ...
    return this.http.get<Client>(
      `${this.baseUrl}/get-Clientby-phone/${phone}`
    );
  }
  ...
  updateClientByPhone(
    ...
    return this.http.put<Client>(
      `${this.baseUrl}/update_client_phone/${phone}`,
      client
    );
  }
  ...
  updateClientLocation(
    ...
    return this.http.put<Client>(
      `${this.baseUrl}/update-client-location/${phone}`,
      {
        latitude,
        longitude
      }
  ...
  updateClientDestination(
    ...
    return this.http.put<Client>(
      `${this.baseUrl}/update-client-destination/${phone}`,
      {
  ...
  existsByPhone(phone: string): Observable<boolean> {
    ...
    return this.http.get<boolean>(
      `${this.baseUrl}/client-exists/${phone}`
    );
  }
  ...
  getClientRideHistory(clientId: number): Observable<any[]> {
    ...
    return this.http.get<any[]>(
      `${this.baseUrl}/client-rides/${clientId}`
    );
  }
  ...
  getClientRideStatistics(clientId: number): Observable<any> {
    ...
    return this.http.get<any>(
      `${this.baseUrl}/client-ride-stats/${clientId}`
    );
  }
  ...
  getClientExpenses(
    ...
    let url =
      `${this.baseUrl}/client-expenses/${clientId}`;
  ...
  getClientTotalExpenses(
    clientId: number
  ): Observable<number> {

    return this.http.get<number>(
      `${this.baseUrl}/client-total-expenses/${clientId}`
    );
  }
  ...
  getClientPreferences(clientId: number): Observable<any> {
    ...
    return this.http.get<any>(
      `${this.baseUrl}/client-preferences/${clientId}`
    );
  }
  ...
  getClientsByLocation(
    ...
    return this.http.get<Client[]>(
      `${this.baseUrl}/clients-by-location`,
      {
        params: {
          lat: lat.toString(),
          lng: lng.toString(),
  ...
  getClientGrowthReport(
    ...
    return this.http.get<any>(
      `${this.baseUrl}/client-growth-report`,
      {
  ...
  getClientsBySegment(
    ...
    return this.http.get<Client[]>(
      `${this.baseUrl}/clients-by-segment/${segment}`
    );
  }
  ...
  sendClientNotification(
    ...
    return this.http.post<void>(
      `${this.baseUrl}/send-client-notification`,
      {
        clientId,
        message,
        type
  ...
  getClientNotifications(
    ...
    return this.http.get<any[]>(
      `${this.baseUrl}/client-notifications/${clientId}`
    );
  }
  ...
  createClientSupportTicket(
    ...
    return this.http.post<any>(
      `${this.baseUrl}/client-support-ticket`,
      {
        clientId,
        issue,
        priority
  ...
  getClientSupportTickets(
    ...
    return this.http.get<any[]>(
      `${this.baseUrl}/client-support-tickets/${clientId}`
    );
  }
  ...
  addMultipleClients(
    ...
    return this.http.post<void>(
      `${this.baseUrl}/add-multiple-clients`,
      clients
    );
  }
  ...
  updateMultipleClients(
    ...
    return this.http.put<Client[]>(
      `${this.baseUrl}/update-multiple-clients`,
      clients
    );
  }
  ...
  verifyClientPhone(
    ...
    return this.http.post<boolean>(
      `${this.baseUrl}/verify-client-phone`,
      {
        phone,
        code
      }
  ...
  getClientRating(
    ...
    return this.http.get<number>(
      `${this.baseUrl}/client-rating/${clientId}`
    );
  }
  ...
  getClientFeedback(
    ...
    return this.http.get<any[]>(
      `${this.baseUrl}/client-feedback/${clientId}`
    );
  }
