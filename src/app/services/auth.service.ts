...
export class AuthService {
  ...
  private baseUrl = 'http://192.168.100.9:8666/api'; // JWT service port
  ...
  return this.http.post<any>(
    'http://192.168.100.9:8777/iwt-authentication/api/auth/verify-identity',
    data
  );
}
resetPassword(token: string, password: string) {
  return this.http.post<any>(
    `http://192.168.100.9:8777/iwt-authentication/api/auth/reset-password?token=${token}`,
